...
valid_barcodes <- SimpleList(list(in_sample = filtered_meta$original_barcodes))
temp_archr_dir <- tempdir()
...
file.rename(ArrowFile, file.path(temp_archr_dir, basename(ArrowFile)))
ArrowFile <- file.path(temp_archr_dir, basename(ArrowFile))
```

#### Score and filter doublets
```{r}
addDoubletScores(input = ArrowFile,
