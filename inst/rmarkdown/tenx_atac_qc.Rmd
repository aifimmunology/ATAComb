...
```{r}
meta_out <- file.path(out_dir, paste0(in_well,"_all_metadata.csv.gz"))
stm(paste("Writing unfiltered metadata to", meta_out))
fwrite(meta, meta_out)

filtered_meta_out <- file.path(out_dir, paste0(in_well, "_filtered_metadata.csv.gz"))
...
```{r}
out_proj <- file.path(out_dir, paste0(in_well, "_saturation_projection.csv.gz"))
