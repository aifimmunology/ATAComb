...
stm(paste0("IN  metadata.csv.gz  : ", in_meta))
...
out_prefix <- file.path(out_dir, paste0(in_batch, "-", in_pool, "_", in_sample))
...
#stm(paste0("Reading merged hashed metadata from ", in_meta))
