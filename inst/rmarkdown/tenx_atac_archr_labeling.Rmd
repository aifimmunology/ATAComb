...
#### [QC Plots](#qc)
- [By Cluster](#qc_cluster)
- [By Unconstrained Type](#qc_un)
- [By Constrained Type](#qc_co)
...
```{r}
qc_violin_plot(proj_meta,
               category_x = "Clusters",
               name_x = "Cluster ID",
               column_y = "nFrags",
               name_y = "log10(N Fragments per Cell)") +
  ggtitle("ArchR Cluster vs N Unique Fragments")
```
...
qc_violin_plot(proj_meta,
               ...
               name_y = "Doublet Enchrichment",
               log_y = FALSE) +
  ggtitle("ArchR Cluster vs Doublet Enrichment")
```
...
qc_violin_plot(proj_meta,
               category_x = "Clusters",
               name_x = "Cluster ID",
               column_y = "PromoterRatio",
               name_y = "Promoter Ratio",
               log_y = FALSE) +
  ggtitle("ArchR Cluster vs Promoter Ratio")
```
```{r}
qc_violin_plot(proj_meta,
               category_x = "Clusters",
               ...
               log_y = FALSE) +
  ggtitle("ArchR Cluster vs TSS Enrichment")
```
...
qc_violin_plot(proj_meta,
               category_x = "Clusters",
               name_x = "Cluster ID",
               column_y = "un_pred_score",
               name_y = "Unconstrained Prediction Score",
               log_y = FALSE) +
  ggtitle("ArchR Cluster vs Unconstrained Score")
```
...
qc_violin_plot(proj_meta,
               category_x = "Clusters",
               name_x = "Cluster ID",
               column_y = "co_pred_score",
               name_y = "Constrained Prediction Score",
               log_y = FALSE) +
  ggtitle("ArchR Cluster vs Constrained Score")
```
...
#### Unconstrained Type Metrics

```{r}
qc_violin_plot(proj_meta,
               category_x = "un_pred_group",
               name_x = "Unconstrained Cell Type",
               column_y = "nFrags",
               name_y = "log10(N Fragments per Cell)",
               fill = "orange") +
  ggtitle("Unconstrained Type vs N Unique Fragments")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "orange")+
  ggtitle("Unconstrained Type vs Doublet Enrichment")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "orange")+
  ggtitle("Unconstrained Type vs Promoter Ratio")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "orange") +
  ggtitle("Unconstrained Type vs TSS Enrichment")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "orange") +
  ggtitle("Unconstrained Type vs Unconstrained Score")
```
...
#### Constrained Type Metrics

```{r}
qc_violin_plot(proj_meta,
               category_x = "co_pred_group",
               name_x = "Constrained Cell Type",
               column_y = "nFrags",
               name_y = "log10(N Fragments per Cell)",
               fill = "limegreen") +
  ggtitle("Constrained Type vs N Unique Fragments")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "limegreen")+
  ggtitle("Constrained Type vs Doublet Enrichment")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "limegreen")+
  ggtitle("Constrained Type vs Promoter Ratio")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "limegreen") +
  ggtitle("Constrained Type vs TSS Enrichment")
```
...
qc_violin_plot(proj_meta,
               ...
               log_y = FALSE,
               fill = "limegreen") +
  ggtitle("Constrained Type vs Constrained Score")
```
[Return to Contents](#contents)
