...
if(is.null(params$in_h5)) {
  in_fra <- system.file("testdata/outs/fragments.tsv.gz", package = "H5weaver")
  in_sin <- system.file("testdata/outs/singlecell.csv", package = "H5weaver")
  in_sum <- system.file("testdata/outs/summary.csv", package = "H5weaver")
  in_key <- system.file("testdata/SampleSheet.csv", package = "H5weaver")
  in_well <- "B000-P0C0W0"
  out_dir <- tempdir()
} else {
