...
```{r}
in_pre <- "/mnt/x060-multiome/X061-pipeline-analysis/preprocessed/"
in_tenx <- "/mnt/x060-multiome/X061-Well1/outs/"
in_key <- "/mnt/x060-multiome/X061-pipeline-analysis/X061_SampleSheet.csv"
in_well <- "X061-AP0C1W1"
genome <- "hg38"
refs <- "altius,tss,gene_bodies"
window_sizes <- "window_5k"
out_dir <- "/mnt/x060-multiome/X061-pipeline-analysis/atac_qc/"
```
...
if(min(doublet_scores[[1]]$doubletEnrich) < 1) {
  ...
  filtered_archr_names <- rownames(archr_meta)[archr_meta$DoubletEnrichment < 1]
